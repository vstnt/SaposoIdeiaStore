...
const ProductDisplay: React.FC<ProductDisplayProps> = ({ productId, truncationN, truncationD }) => {
  ...
  return (
    ...
    : 'border-slate-300 bg-slate-100/90'}`}>
      ...
      <div className=" bg-slate-400 basis-1/12 flex flex-col items-end justify-between text-xs">
        <div id="preço" className="mt-2  font-semibold flex"><div className="w-20">R$ {product.price}</div></div> 
