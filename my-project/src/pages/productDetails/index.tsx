    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-r from-slate-400 to-violet-950 px-5 pt-28">
        <div className=" flex gap-1">
          ...
          <div className="text-green-400 bg-slate-900/50 border border-zinc-600 basis-7/12 rounded-lg p-2 grid content-start h-fit"> 
          ...
          <div className="basis-5/12  grid justify-items-center content-between">
            <img className="rounded w-11/12" src={product.imageUrl}></img>
          </div> 
